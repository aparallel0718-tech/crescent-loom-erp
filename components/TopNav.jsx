...
const ICONS = {
  dashboard: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M3 11.5 12 4l9 7.5" /><path d="M5 10v10h14V10" /></svg>),
  products: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="3" width="8" height="8" rx="1.5" /><rect x="13" y="3" width="8" height="8" rx="1.5" /><rect x="3" y="13" width="8" height="8" rx="1.5" /><rect x="13" y="13" width="8" height="8" rx="1.5" /></svg>),
  inventory: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M21 8 12 3 3 8l9 5 9-5Z" /><path d="M3 8v8l9 5 9-5V8" /></svg>),
  sales: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M3 17 9 11l4 4 8-8" /><path d="M15 7h6v6" /></svg>),
  customers: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="12" cy="8" r="3.2" /><path d="M5 21c0-4 3-6.5 7-6.5s7 2.5 7 6.5" /></svg>),
  purchases: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 4h2l1.5 12h11L21 8H7" /><circle cx="9" cy="20" r="1.3" /><circle cx="17" cy="20" r="1.3" /></svg>),
  shipping: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="2" y="7" width="12" height="9" rx="1.2" /><path d="M14 10h4l3 3v3h-7" /><circle cx="6.5" cy="18.5" r="1.4" /><circle cx="17.5" cy="18.5" r="1.4" /></svg>),
  marketing: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M3 10v4h4l6 4V6L7 10H3Z" /><path d="M16 9a4 4 0 0 1 0 6" /></svg>),
  expenses: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="3" y="4" width="18" height="16" rx="1.5" /><path d="M7 9h10M7 13h6" /></svg>),
  pnl: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 19V5M4 19h16" /><path d="M8 15l3-4 3 2 4-6" /></svg>),
  analytics: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><rect x="4" y="12" width="3.5" height="8" /><rect x="10.25" y="7" width="3.5" height="13" /><rect x="16.5" y="3" width="3.5" height="17" /></svg>),
  alerts: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M12 3a5 5 0 0 0-5 5v3.5L5 15h14l-2-3.5V8a5 5 0 0 0-5-5Z" /><path d="M10 18a2 2 0 0 0 4 0" /></svg>),
  'cost-templates': (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M4 7h16M4 12h16M4 17h10" /></svg>),
  users: (<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><circle cx="9" cy="8" r="3" /><path d="M2 20c0-3.5 3-6 7-6s7 2.5 7 6" /><path d="M17 8.5a2.5 2.5 0 1 1 0-5" /><path d="M22 20c0-3-2-5-4.5-5.7" /></svg>),
};
    ...
    <header ref={containerRef} className="sticky top-0 z-40">
      <div className="flex items-center justify-between gap-4 px-6 py-3">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button className={`relative w-9 h-9 rounded-full flex items-center justify-center text-[#F2F1EE] ${glass}`}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8"><path d="M12 3a5 5 0 0 0-5 5v3.5L5 15h14l-2-3.5V8a5 5 0 0 0-5-5Z" /><path d="M10 18a2 2 0 0 0 4 0" /></svg>
          </button>
          <div className={`flex items-center gap-2 rounded-full pl-1.5 pr-3 py-1.5 ${glass}`}>
            <div className="w-7 h-7 rounded-full bg-gold flex items-center justify-center text-xs font-semibold text-black shrink-0">
              {initial}
            </div>
            <div className="hidden sm:block">
              <p className="text-xs font-medium text-[#F2F1EE] leading-none">{name}</p>
          ...
          {openGroup && (
            <>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                {groups.find((g) => g.name === openGroup).items.map((item) => (
                  <Link
                    key={item.href}
                    href={item.href}
                  ...
                  >
                    <span className="text-gold mt-0.5">{iconFor(item)}</span>
                    <span>
                      <span className="block text-sm text-[#F2F1EE] font-medium">{item.label}</span>
